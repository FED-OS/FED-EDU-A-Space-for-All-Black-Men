...
Same file, second half: styling your house. The Warm Study theme of this repo (styles.css at the root) is a complete ready-to-wear paint job — you'll copy three lines of CSS from it into your own file and watch your page transform. Then you'll change the colors to yours. Painting is where the house stops being a skeleton and starts being yours.
