...
### The Warm Study starter paint job
...
```css
body { background: #f7f2e9; color: #2a2520; font-family: Georgia, serif; }
h1   { color: #256d46; }
a    { color: #256d46; }
```

Cream paper ground, dark ink walls readable at midnight, forest green doors and name plates. That green — `#256d46` — is the block's signature. A brother who knows the block recognizes it on sight.

Then make it yours: change `#256d46` to your color. Any hex code works — search "color picker" and grab any green, gold, blue, red you want. The house you build should be the house you'd live in.
